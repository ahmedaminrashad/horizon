...
- Obtain SSL certificates for `operate.indicator-app.com`
...
# Obtain certificate for operate
sudo certbot --nginx -d operate.indicator-app.com
...
- **Operate**: `https://operate.indicator-app.com/`
