...
import { AddDateOfBirthGenderSecondPhoneToDoctors1776000000024 } from './1776000000024-AddDateOfBirthGenderSecondPhoneToDoctors';
import { CreateDoctorFilesTable1776000000025 } from './1776000000025-CreateDoctorFilesTable';
...
import { AddClinicIdToDoctorWorkingHours1776000000030 } from './1776000000030-AddClinicIdToDoctorWorkingHours';
...
import { AddFeesToDoctorBranches1776000000039 } from './1776000000039-AddFeesToDoctorBranches';
...
export const clinicMigrations: (new () => MigrationInterface)[] = [
  ...
  AddDateOfBirthGenderSecondPhoneToDoctors1776000000024,
  CreateDoctorFilesTable1776000000025,
  ...
  AddClinicIdToDoctorWorkingHours1776000000030,
  ...
  AddFeesToDoctorBranches1776000000039,
];
